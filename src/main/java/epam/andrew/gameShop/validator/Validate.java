...
public class Validate {
    ...
    private static final String EMPTY_LOGIN = "emptyLogin";
    private static final String EMPTY_SURNAME = "emptySurname";
    ...
    private static final String EMPTY_COUNTRY = "emptyCountry";
    private static final String EMAIL_USED_ERROR = "emailUsed";
    private static final String WRONG_EMAIL_ERROR = "wrongEmail";
    private static final String WRONG_NAME_ERROR = "wrongName";
    private static final String WRONG_LOGIN_ERROR = "wrongLogin";
    private static final String WRONG_COUNTRY_ERROR = "wrongCountry";
    private static final String WRONG_SURNAME_ERROR = "wrongSurname";
    private static final String WRONG_PHONE_ERROR = "wrongPhoneNumber";
