...
public class ShowUsersListPageAction implements Action {
    private static final Logger LOG = LoggerFactory.getLogger(ShowUsersListPageAction.class);
    private static final String ERROR = "Couldn't show users list page";
    ...
    public ActionResult execute(HttpServletRequest req, HttpServletResponse resp) throws ActionException, ServiceException {
        ...
        String path = Constant.USERS_LIST;
