    ...
    <div class="panel-body">
        <div class="row">
            <div class=" col-md-9 col-lg-9 ">
                ...
                <a href="editProfile.jsp" class="btn btn-primary"><fmt:message key="editProfile.button"/></a>
                <a href="changePassword.jsp" class="btn btn-primary"><fmt:message key="password.button"/></a>
                <a href="transactions.jsp" class="btn btn-primary"><fmt:message key="transactions.button"/></a>
            </div>
        </div>
    </div>
</div>
