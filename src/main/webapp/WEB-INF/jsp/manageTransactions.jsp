...
<fmt:bundle basename="language">
    ...
    <fmt:message key="user.button" var="us_er"/>
    <fmt:message key="id" var="transction_id"/>
...
<section class="pro-box">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form-group input-group" style="margin-bottom: 0px">
                                    <form action="<c:url value="/do/status"/>" method="post"
                            ...
                            <td>
                                ...
                                <a class="delete" title="Delete" <c:url
                                        value="/do/deleteTransaction?userId=${transaction.id}"/>
                                   data-toggle="tooltip"><i class="material-icons"></i></a>
                            </td>
                        </tr>
                    </c:forEach>
    ...
    <div class="row justify-content-center" style="margin-top: 30px">
        <div class="col-12 p-0">
            <:pagination url="/do/transactionManage" pagesCount="${pagesCount}"/>
        </div>
    </div>
</section>
